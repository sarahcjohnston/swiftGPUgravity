...
/* Construct types for MPI communications */
  ...
  /* Init the scheduler. */
  //scheduler_init(&e->sched, e->s, maxtasks, nr_queues,0, e->nodeID, &e->threadpool);
  scheduler_init(&e->sched, e->s, maxtasks, nr_queues,(e->policy & scheduler_flag_steal), e->nodeID, &e->threadpool);
