...
enum {
  ...
  timer_doself_sinks_density,
  timer_doself_sinks_swallow,
  ...
  timer_dopair_sinks_density,
  timer_dopair_sinks_swallow,
  ...
  timer_dosub_self_sinks_density,
  timer_dosub_self_sinks_swallow,
  ...
  timer_dosub_pair_sinks_density,
  timer_dosub_pair_sinks_swallow,
  timer_doself_subset,
  timer_dopair_subset,
