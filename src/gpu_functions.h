...
/*void gravity_gpu_allocate_mem_host(struct gravity_gpu_values_host *gravity_gpu_values, int ncells, int max_cell_size){
	...
	cudaMallocHost((void **)&gravity_gpu_values->cell_active, ncells * sizeof(int));
	}
...
/*void gravity_gpu_H2D(struct gravity_gpu_values_host *gravity_gpu_values_h, struct gravity_gpu_values_device *gravity_gpu_values_d, int ncells, int max_cell_size, cudaStream_t stream){
	...
	cudaMemcpyAsync(gravity_gpu_values_d->d_mass_i, gravity_gpu_values_h->mass_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_mass_j, gravity_gpu_values_h->mass_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_x_i, gravity_gpu_values_h->x_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_y_i, gravity_gpu_values_h->y_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_z_i, gravity_gpu_values_h->z_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_x_j, gravity_gpu_values_h->x_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_y_j, gravity_gpu_values_h->y_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_z_j, gravity_gpu_values_h->z_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_x_i, gravity_gpu_values_h->a_x_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_y_i, gravity_gpu_values_h->a_y_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_z_i, gravity_gpu_values_h->a_z_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_x_j, gravity_gpu_values_h->a_x_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_y_j, gravity_gpu_values_h->a_y_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_a_z_j, gravity_gpu_values_h->a_z_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_pot_i, gravity_gpu_values_h->pot_i, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_pot_j, gravity_gpu_values_h->pot_j, ncells * max_cell_size * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_active_i, gravity_gpu_values_h->active_i, ncells * max_cell_size * sizeof(int), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_active_j, gravity_gpu_values_h->active_j, ncells * max_cell_size * sizeof(int), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_CoM_i, gravity_gpu_values_h->CoM_i, ncells * 3 * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_CoM_j, gravity_gpu_values_h->CoM_j, ncells * 3 * sizeof(float), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_gcounts, gravity_gpu_values_h->gcounts, ncells * sizeof(int), cudaMemcpyHostToDevice, stream);
	cudaMemcpyAsync(gravity_gpu_values_d->d_cell_active, gravity_gpu_values_h->cell_active, ncells * sizeof(int), cudaMemcpyHostToDevice, stream);
		}
		
void gravity_gpu_D2H(struct gravity_gpu_values_host *gravity_gpu_values_h, struct gravity_gpu_values_device *gravity_gpu_values_d, int ncells, int max_cell_size, cudaStream_t stream){
	cudaMemcpyAsync(gravity_gpu_values_h->a_x_i, gravity_gpu_values_d->d_a_x_i, ncells * max_cell_size * sizeof(float), cudaMemcpyDeviceToHost, stream);
	cudaMemcpyAsync(gravity_gpu_values_h->a_y_i, gravity_gpu_values_d->d_a_y_i, ncells * max_cell_size * sizeof(float), cudaMemcpyDeviceToHost, stream);
	cudaMemcpyAsync(gravity_gpu_values_h->a_z_i, gravity_gpu_values_d->d_a_z_i, ncells * max_cell_size * sizeof(float), cudaMemcpyDeviceToHost, stream);
	cudaMemcpyAsync(gravity_gpu_values_h->a_x_j, gravity_gpu_values_d->d_a_x_j, ncells * max_cell_size * sizeof(float), cudaMemcpyDeviceToHost, stream);
	cudaMemcpyAsync(gravity_gpu_values_h->a_y_j, gravity_gpu_values_d->d_a_y_j, ncells * max_cell_size * sizeof(float), cudaMemcpyDeviceToHost, stream);
